...
//imp**Note: if we use a tag (<a herf=''>) the entire page will refresh or new domm will create to avoide the reload of entire page we use link tag in react using react router
